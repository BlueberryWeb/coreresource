...
<head>
    ...
    <link rel="preload" href="{{ asset('front/css/animate.css') }}"/>
    <link rel="preload" href="{{ asset('front/js/script.js') }}"/>
    <link rel="preload" href="{{ asset('front/js/lib/easy-waypoint-animate.js') }}"/>
    <link rel="preload" href="{{ asset('front/js/lib/jquery.waypoints.js') }}"/>
    <link rel="preload" href="{{ asset('front/js/lib/jquery.waypoints.min.js') }}"/>
    <link rel="preload" href="{{ asset('front/vid/bg-footer-vertical.mp4') }}"/>
    <link rel="preload" href="{{ asset('front/vid/bg-hire-vertical.mp4') }}"/>
    <link rel="preload" href="{{ asset('front/vid/bg-hire.mp4') }}"/>
    <!-- CARROUSEL -->
...
<body>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-5 mb-5">
                        <div class="txt-who">
                            ...
                            <p class="gRegular mb-2">Your trustred partner for HR solutions, </p>
        ...
        <div class="container bg-who pb-5 pt-1">
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-lg-10">
                    <div class="text-center">
                        <h1 class="mExtraBold display-4 txt-negro">What do <b class="txt-azul">we do?</b><img src="{{ asset('front/img/complemento-tit.webp') }}" alt="WHAT DO WE DO" class="img-fluid compl-tit ms-2"/></h1>
                    </div>
                    ...
                    <div class="d-flex justify-content-center pt-5 cards-who">
                        <div class="mx-3">
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center">
                                        <img loading="lazy" src="{{ asset('front/img/international-payroll.webp') }}" alt="INTERNATIONAL PAYROLL" class="img-fluid img-what"/>
                                    </div>
                                    <div class="mx-4 pt-3">
                                        <h5 class="mLight h3">International</h5>
                                        <h5 class="mBold h3 mb-4">Payroll</h5>
                                        <p class="gRegular txt-gris mb-2">Have an intelligent international </p>
                                        <p class="gRegular txt-gris mb-2">payroll management system to</p>
                                        <p class="gRegular txt-gris mb-2">ensure the loyalty of your </p>
                                        <p class="gRegular txt-gris mb-2">employees.</p>
                                    </div>   
                                </div>
                            </div>
                        </div>
                        <div class="mx-3">
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center">
                                        <img loading="lazy" src="{{ asset('front/img/taxes-benefits.webp') }}" alt="EMPLOYEE TAXES AND BENEFITS" class="img-fluid img-what-2"/>
                                    </div>
                                    <div class="mx-4 pt-3">
                                        <h5 class="mLight h3">Employee taxes  </h5>
                                        <h5 class="mBold h3 mb-4">and benefits</h5>
                                        <p class="gRegular txt-gris mb-2">Tax and benefits management of</p>
                                        <p class="gRegular txt-gris mb-2">your work force in compliance</p>
                                        <p class="gRegular txt-gris mb-2">with the local law.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="mx-3">
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center">
                                            <img loading="lazy" src="{{ asset('front/img/business-compliance.webp') }}" alt="BUSINESS COMPLIANCE" class="img-fluid img-what-3"/>
                                    </div>
                                    <div class="mx-4 pt-3">
                                        <h5 class="mLight h3">Business</h5>
                                        <h5 class="mBold h3 mb-4">compliance</h5>
                                        <p class="gRegular txt-gris mb-2">We ensure the management of </p>
                                        <p class="gRegular txt-gris mb-2">companies in their fulfillment </p>
                                        <p class="gRegular txt-gris mb-2">of human capital.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- HIRE ANYONE FROM  ANYWHERE -->
         ...
         <div class="d-block d-sm-block d-md-none">
            <section class="showcase" id="showcase">
                ...
                <video src="{{ asset('front/vid/bg-hire-vertical.mp4') }}" muted loop autoplay></video>
            </section>
         </div>
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-6 col-sm-6 col-md-6 col-lg-5">
                                    <div class="pt-2">
                                        ...
                                        <p class="gRegular txt-gris h6 txt-gris my-0">Companies we have</p>
                                        <p class="gRegular txt-gris h6 txt-gris mt-0">worked with.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container py-5" id="benefits">
        <div class="row mb-4">
            <div class="text-center">
                <h1 class="mExtraBold display-4 txt-negro">Our <b class="txt-azul">benefits</b><img  src="{{ asset('front/img/complemento-tit.webp') }}" alt="CORE" class="img-fluid compl-tit ms-2"/></h1>                
                      ...
                      <div class="card2">
                        ...
                        <div class="back">
                            ...
                            <div class="mx-4">
                                ...
                                <h3 class="mBold mt-0 h4 mb-4">work.</h3>
                      ...
                      <div class="card2">
                        ...
                        <div class="back">
                            ...
                            <div class="mx-4">
                                ...
                                <h3 class="mBold h4 mt-0 mb-4">through us.</h3>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mx-4 pt-3">
                                            ...
                                            <h5 class="mBold mb-0 pt-2 h5">We take care </h5>
                                            <h5 class="mLight mt-0 h5">of the hiring process</h5>
                                            <p class="mb-2 gRegular txt-gris pt-3">From the search for candidates, </p>
                                            <p class="mb-2 gRegular txt-gris">to the legal aspects, we will be in </p>
                                            <p class="mb-2 gRegular txt-gris">the whole process.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mx-4 pt-3">
                                            ...
                                            <h5 class="mBold mb-0 pt-2 h5">We take the</h5>
                                            <h5 class="mLight mt-0 h5">responsability</h5>
                                            <p class="mb-2 gRegular txt-gris pt-3">Don’t worry about payroll, </p>
                                            <p class="mb-2 gRegular txt-gris">benefits or paying taxes, we do it</p>
                                            <p class="mb-2 gRegular txt-gris">for you.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mx-4 pt-3">
                                            ...
                                            <h5 class="mBold mb-0 pt-1 h5">Global</h5>
                                            <h5 class="mLight mt-0 h5">remote team</h5>
                                            <p class="mb-2 gRegular txt-gris pt-3">Your team can work remotely </p>
                                            <p class="mb-2 gRegular txt-gris">from anywhere. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mx-4 pt-3">
                                            ...
                                            <h5 class="mBold mb-0 pt-2 h4">We take the</h5>
                                            <h5 class="mLight mt-0 h4">responsability</h5>
                                            <p class="mb-2 gRegular txt-gris pt-3">Don’t worry about payroll, </p>
                                            <p class="mb-2 gRegular txt-gris">benefits or paying taxes, we do it</p>
                                            <p class="mb-2 gRegular txt-gris">for you.</p>
                                        </div>
